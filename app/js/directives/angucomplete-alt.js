 ...
 * This is a fork of Hidenari Nozaki with some small changes to fit the layout.
 * By Daniele Bertella
 */
...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', [] )
    ...
    $templateCache.put(TEMPLATE_URL,
        ...
        '  <input id="{{id}}_value" ng-model="searchStr" placeholder="{{placeholder}}" ng-disabled="disableInput" type="{{type}}" maxlength="{{maxlength}}" ng-focus="onFocusHandler()" class="{{inputClass}}" ng-focus="resetHideResults()" ng-blur="hideResults($event)" autocapitalize="off" autocorrect="off" autocomplete="off" ng-change="inputChangeHandler(searchStr)" required/>' +
